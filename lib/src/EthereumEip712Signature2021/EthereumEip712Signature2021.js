...
export function getTypesForEIP712Domain(params) {
    var _a, _b, _c, _d, _e;
    return [
        typeof ((_a = params.domain) === null || _a === void 0 ? void 0 : _a.name) === 'string' && { name: 'name', type: 'string' },
        ((_b = params.domain) === null || _b === void 0 ? void 0 : _b.version) && { name: 'version', type: 'string' },
        typeof ((_c = params.domain) === null || _c === void 0 ? void 0 : _c.chainId) === 'number' && {
            name: 'chainId',
            type: 'uint256',
        },
        ((_d = params.domain) === null || _d === void 0 ? void 0 : _d.verifyingContract) && {
            name: 'verifyingContract',
            type: 'address',
        },
        ((_e = params.domain) === null || _e === void 0 ? void 0 : _e.salt) && { name: 'salt', type: 'bytes32' },
    ].filter(Boolean);
}
...
class EthereumEip712Signature2021 extends suites.LinkedDataSignature {
    ...
    generateKeyPair(seed) {
        return __awaiter(this, void 0, void 0, function* () {
            if (seed) {
                ...
                // @ts-ignore
                this.mnemonic = yield bip39.generateMnemonic(256, crypto.randomBytes);
            }
            const mnemonic = yield Mnemonic.fromPhrase(this.mnemonic);
            const wallet = yield HDNodeWallet.fromMnemonic(mnemonic, `m/44'/60'/0'/0/${this.index}`);
            this.wallet = wallet;
    ...
    switchAccount(index) {
        return __awaiter(this, void 0, void 0, function* () {
            const mnemonic = yield Mnemonic.fromPhrase(this.getMnemonic());
            const wallet = yield HDNodeWallet.fromMnemonic(mnemonic, `m/44'/60'/0'/0/${index}`);
            this.wallet = wallet;
            const account = yield this.web3.eth.accounts.privateKeyToAccount(wallet.privateKey);
            this.account = account;
            return {
    ...
    sign(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.web3._provider !== undefined && this.web3._provider !== null) {
                //@ts-ignore
                const from = (yield this.web3._provider.selectedAddress) ? yield this.web3._provider.selectedAddress : this.web3._provider.accounts;
                ...
                {
                    //@ts-ignore
                    proofValue = yield signTypedData_v4(Buffer.from(this.wallet.privateKey.replace('0x', ''), 'hex'), { data: verifyData });
                }
            }
