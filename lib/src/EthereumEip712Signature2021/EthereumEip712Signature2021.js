...
class EthereumEip712Signature2021 extends suites.LinkedDataSignature {
    ...
    createProof(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let embed = (_a = options.embed) !== null && _a !== void 0 ? _a : true;
            ...
            let domain = (_b = options.domain) !== null && _b !== void 0 ? _b : {};
            const primaryType = (_c = options.primaryType) !== null && _c !== void 0 ? _c : "Document";
            const eip712TypedData = new Eip712Types_1.EIP712TypedData();
            let types = (_d = options.types) !== null && _d !== void 0 ? _d : eip712TypedData.generateTypes(options.document, primaryType);
    ...
    verifyProof(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let domain = (_a = options.domain) !== null && _a !== void 0 ? _a : {};
            const primaryType = (_b = options.primaryType) !== null && _b !== void 0 ? _b : "Document";
            const eip712TypedData = new Eip712Types_1.EIP712TypedData();
            let types = (_c = options.types) !== null && _c !== void 0 ? _c : eip712TypedData.generateTypes(options.document, primaryType);
